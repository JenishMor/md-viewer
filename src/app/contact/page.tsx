  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!serviceId || !templateId || !publicKey) {
        throw new Error(
          "Email service configuration is missing. Please contact us directly at support@mdviewer.in",
        );
      }
      ...
      <article className="max-w-5xl mx-auto py-12 px-4 space-y-16 w-full min-w-0 break-words">
        ...
        <header className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            from you. Your feedback directly shapes the future of MDViewer.
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
              ...
              {status === "success" ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    ...
                    24-48 hours. In the meantime, feel free to explore our{" "}
                    <Link
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card border rounded-2xl p-6 space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                We typically respond within <strong>24-48 hours</strong>. For
            ...
            <div className="bg-card border rounded-2xl p-6 space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                For technical bugs or feature requests, you can also open an
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 rounded-2xl p-6 space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Check out our comprehensive Markdown tutorial for tips and
                syntax help.
              </p>
              <Link
                href="/markdown-tutorial"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-muted/30 rounded-2xl p-6 space-y-3">
              <h3 className="font-bold">
                How do I report a Markdown rendering issue?
              </h3>
              <p className="text-muted-foreground text-sm">
                If you notice that specific Markdown syntax isn't rendering
                correctly, please include the exact Markdown text in your
                message along with the expected output. Screenshots are also
                helpful!
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-muted-foreground text-sm">
                Absolutely! We love hearing feature ideas from our users. Just
                select "Feature Request" from the subject dropdown and describe
                your idea in detail.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-6 space-y-3">
              <h3 className="font-bold">
                Is MDViewer available for partnership?
              </h3>
              <p className="text-muted-foreground text-sm">
                We're open to collaborations, integrations, and partnerships.
                Select "Business Inquiry" and tell us about your ideas.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-6 space-y-3">
              <h3 className="font-bold">How can I contribute to MDViewer?</h3>
              <p className="text-muted-foreground text-sm">
                MDViewer is open source! Check out our{" "}
                <a
