...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Master all GFM extensions—tables, task lists, autolinks, strikethrough, and syntax highlighting.",
...
export default function GFMGuide() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        headline: "The Complete Guide to GitHub Flavored Markdown (GFM)",
        description:
          "Master GitHub Flavored Markdown with our comprehensive guide. Learn tables, task lists, autolinks, strikethrough, syntax highlighting, and all GFM extensions used on GitHub.",
        author: {
          "@type": "Person",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: "https://mdviewer.in/guides/github-flavored-markdown",
          },
        ],
      },
    ],
      ...
      <article className="max-w-4xl mx-auto py-12 px-4 space-y-12">
        ...
        <header className="space-y-6 border-b pb-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            GitHub Flavored Markdown (GFM) extends standard Markdown with
            powerful features like tables, task lists, and syntax highlighting.
            This comprehensive guide covers everything you need to master GFM
        ...
        <nav className="bg-muted/50 rounded-2xl p-6 border">
          ...
          <ul className="grid md:grid-cols-2 gap-2 text-sm">
            <li>
              <a href="#what-is-gfm" className="text-primary hover:underline">
            ...
            <li>
              <a href="#strikethrough" className="text-primary hover:underline">
                Strikethrough
              </a>
            </li>
            <li>
              <a href="#autolinks" className="text-primary hover:underline">
                Autolinks
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#footnotes" className="text-primary hover:underline">
                Footnotes
              </a>
            </li>
            <li>
              <a href="#emoji" className="text-primary hover:underline">
                Emoji Support
              </a>
            </li>
            <li>
        ...
        <section id="what-is-gfm" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              <strong>GitHub Flavored Markdown (GFM)</strong> is GitHub's own
              variant of Markdown that adds several extensions to the standard
              CommonMark specification. These extensions were developed to meet
              the needs of software developers who write documentation, issues,
              pull requests, and README files on GitHub.
            </p>
            <p>
              When you write Markdown on GitHub—whether in README files, issues,
              comments, or wikis—you're using GFM. The same applies to GitLab,
              which has adopted most GFM extensions, and many other platforms
              like Discord, Notion, and Slack that support subsets of GFM.
            </p>
          </div>
          <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-xl p-6">
            ...
            <p className="text-green-800 dark:text-green-200">
              ...
              . The specification is built on top of CommonMark and is
              maintained by GitHub's engineering team.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-card rounded-xl border">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Colored code blocks for many languages
                </p>
              </div>
              <div className="p-4 bg-card rounded-xl border">
        ...
        <section id="tables" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Tables are one of the most useful GFM extensions. They allow you
              to organize data in rows and columns without resorting to HTML.
              The syntax uses pipes (<code>|</code>) and hyphens (<code>-</code>
              ).
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Use colons in the header separator row to control text alignment
                in each column:
              </p>
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4 text-sm">
              ...
              <span className="text-amber-700 dark:text-amber-300">
                The pipes at the start and end of lines are optional, but
                including them makes tables easier to read in raw Markdown.
              </span>
            </div>
          </div>
        </section>
        ...
        <section id="task-lists" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Task lists are interactive checklists that use a simple syntax.
              They're commonly used in issues, pull requests, and project
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            <div className="bg-card rounded-xl p-6 border">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2">
                  <input type="checkbox" disabled className="rounded" /> Code
                  review
                </li>
                <li className="flex items-center gap-2">
                  <input type="checkbox" disabled className="rounded" /> Deploy
                  to production
                </li>
              </ul>
            </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-xl p-4 text-sm">
            ...
            <span className="text-blue-700 dark:text-blue-300">
              On GitHub issues and pull requests, task lists are interactive—you
              can click to check/uncheck items directly!
            </span>
          </div>
        </section>
        ...
        <section id="strikethrough" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Strikethrough text is created by wrapping text in double tildes (
              <code>~~</code>). It's useful for indicating deleted or deprecated
              content without removing it entirely.
            </p>
          </div>
        ...
        <section id="autolinks" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              GFM automatically converts URLs and email addresses into clickable
              links. This applies to <code>http://</code>, <code>https://</code>
              , and <code>www.</code> URLs.
            </p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border font-mono text-sm">
            <div className="text-xs text-muted-foreground mb-3 font-sans font-medium">
              EXAMPLES OF AUTOLINKS
            </div>
            <div className="space-y-2">
              <div>
                https://mdviewer.in →{" "}
                <span className="text-primary underline">clickable link</span>
              </div>
              <div>
                www.example.com →{" "}
                <span className="text-primary underline">clickable link</span>
              ...
              <div>
                support@mdviewer.in →{" "}
                <span className="text-primary underline">mailto link</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="syntax-highlighting" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Code blocks in GFM support syntax highlighting for many
              programming languages. Simply add the language identifier after
              the opening triple backticks.
            </p>
          </div>
          <div className="space-y-6">
            <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border font-mono text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <div
                    key={lang}
                    className="px-3 py-2 bg-muted rounded-lg text-sm font-mono text-center"
                  >
                    {lang}
                  </div>
                ))}
        ...
        <section id="footnotes" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Footnotes allow you to add notes and references without cluttering
              your main text. They're rendered at the bottom of the document.
            </p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border font-mono text-sm">
            <div className="text-xs text-muted-foreground mb-3 font-sans font-medium">
        ...
        <section id="emoji" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              GitHub supports emoji shortcodes that convert to emoji characters.
              Use colons around the emoji name.
            </p>
          </div>
        ...
        <section id="mentions" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              On GitHub, you can mention users and reference issues/PRs directly
              in your Markdown:
            </p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody className="text-sm">
                <tr className="border-b">
                  ...
                  <td className="p-3">
                    Links to user profile, notifies the user
                  </td>
                </tr>
                <tr className="border-b">
        ...
        <section id="disallowed-html" className="space-y-6 scroll-mt-20">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              While GFM allows inline HTML, certain tags are filtered out for
              security reasons. These include:
            </p>
          </div>
        ...
        <section className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 rounded-3xl p-8 md:p-12 border border-green-200 dark:border-green-800 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            MDViewer fully supports GitHub Flavored Markdown. Try out tables,
            task lists, and syntax highlighting with instant preview.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Learn the fundamentals before diving into GFM extensions.
              </p>
            </Link>
            <Link
            ...
            >
              <h3 className="font-bold group-hover:text-primary transition-colors">
                Markdown Tables Deep Dive →
              </h3>
              <p className="text-sm text-muted-foreground mt-2">
                Advanced table techniques and styling options.
              </p>
            </Link>
          </div>
        </section>
