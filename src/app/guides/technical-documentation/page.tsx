      ...
      <article className="max-w-4xl mx-auto py-12 px-4 space-y-12">
        ...
        <header className="space-y-6 border-b pb-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Great documentation is the difference between a product that frustrates users and one that delights them. Learn how to create professional technical documentation using Markdown—the same approach used by GitHub, Microsoft, and leading tech companies.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
            <h4 className="font-bold text-blue-900 dark:text-blue-100 mb-2">🔧 Popular Docs-as-Code Tools</h4>
            <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
              <li>• <strong>MkDocs</strong> — Python-based, Material theme</li>
              <li>• <strong>Docusaurus</strong> — React-based, by Meta</li>
              <li>• <strong>GitBook</strong> — Hosted platform with editor</li>
              <li>• <strong>VitePress</strong> — Vue-based static site generator</li>
              <li>• <strong>Sphinx</strong> — Python documentation standard</li>
            </ul>
          </div>
        </section>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 items-start p-5 bg-card rounded-xl border">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Put the most important information first. Users scan documentation—make key points visible immediately.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start p-5 bg-card rounded-xl border">
        ...
        <section className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 bg-green-50 dark:bg-green-950/30 rounded-2xl border border-green-200 dark:border-green-800">
              <h3 className="font-bold text-lg mb-4 text-green-900 dark:text-green-100">✅ Best Practices</h3>
              <ul className="space-y-3 text-sm text-green-800 dark:text-green-200">
                <li>• Use active voice ("Click the button" not "The button should be clicked")</li>
            ...
            <div className="p-6 bg-red-50 dark:bg-red-950/30 rounded-2xl border border-red-200 dark:border-red-800">
              <h3 className="font-bold text-lg mb-4 text-red-900 dark:text-red-100">❌ Common Mistakes</h3>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-5 bg-card rounded-xl border">
              <h4 className="font-semibold mb-2">📋 Task Lists for Prerequisites</h4>
              <code className="text-sm bg-muted px-2 py-1 rounded">- [x] Node.js 18+ installed</code>
            </div>
            <div className="p-5 bg-card rounded-xl border">
              <h4 className="font-semibold mb-2">📊 Tables for Parameter Reference</h4>
              <code className="text-sm bg-muted px-2 py-1 rounded">| Param | Type | Description |</code>
            </div>
            <div className="p-5 bg-card rounded-xl border">
              <h4 className="font-semibold mb-2">💻 Fenced Code with Language</h4>
