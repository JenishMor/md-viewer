...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive guides and tutorials to master Markdown. Learn README writing, documentation best practices, GFM features, and advanced techniques for developers and writers.",
  keywords: [
    "markdown guides",
    "markdown tutorials",
    "learn markdown",
  ...
  openGraph: {
    title: "Markdown Guides & Tutorials | MDViewer Learning Center",
    description:
      "Comprehensive guides and tutorials to master Markdown. From beginner basics to advanced documentation techniques.",
...
const guides = [
  {
    ...
    description:
      "Master the art of README writing. Learn structure, essential sections, badges, and examples that make your GitHub projects stand out.",
  ...
  },
  {
    ...
    description:
      "Understand the key differences between Markdown and traditional word processors. Learn when each format shines and how to choose.",
  ...
  },
  {
    ...
    description:
      "Everything you need to know about GFM extensions—tables, task lists, autolinks, strikethrough, and syntax highlighting.",
    category: "GFM",
  ...
  },
  {
    ...
    description:
      "Professional techniques for writing user guides, API docs, and knowledge bases. Structure, style, and tools that professionals use.",
    category: "Documentation",
  ...
  },
  {
    ...
    description:
      "How content creators use Markdown to write faster, format consistently, and publish to platforms like Dev.to, Medium, and WordPress.",
    category: "Writing",
      ...
      <article className="max-w-5xl mx-auto py-12 px-4 space-y-16">
        ...
        <header className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            In-depth guides written by developers, for developers. Master
            Markdown, improve your documentation, and level up your technical
            writing skills.
          </p>
        </header>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground">
                Start with our comprehensive tutorial that covers everything
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {featuredGuides.map((guide) => {
              ...
              return (
                ...
                >
                  <div
                    className={`h-12 w-12 ${colors.bg} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
            ...
            {moreGuides.map((guide) => {
              ...
              return (
                <Link
                  key={guide.slug}
                  href={`/guides/${guide.slug}`}
                  className="group flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 p-5 sm:p-6 bg-card rounded-2xl border hover:shadow-lg transition-all"
                >
                  <div
                    className={`h-12 w-12 sm:h-14 sm:w-14 ${colors.bg} rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform`}
                  >
                  ...
                  <ArrowRight className="hidden sm:block w-5 h-5 text-muted-foreground group-hover:text-primary transition-colors shrink-0" />
                </Link>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="p-6 bg-blue-50 dark:bg-blue-950/30 rounded-2xl border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
                Guides focused on writing professional documentation, READMEs,
                and user guides.
              </p>
            ...
            <div className="p-6 bg-green-50 dark:bg-green-950/30 rounded-2xl border border-green-200 dark:border-green-800">
              ...
              <p className="text-sm text-green-700 dark:text-green-300 mb-4">
                Deep dives into GitHub Flavored Markdown features and syntax
                details.
              </p>
              <ul className="space-y-2 text-sm">
                <li>
            ...
            <div className="p-6 bg-purple-50 dark:bg-purple-950/30 rounded-2xl border border-purple-200 dark:border-purple-800">
              ...
              <p className="text-sm text-purple-700 dark:text-purple-300 mb-4">
                Tips and techniques for content creators and bloggers using
                Markdown.
              </p>
              <ul className="space-y-2 text-sm">
                <li>
            ...
            <div className="p-6 bg-red-50 dark:bg-red-950/30 rounded-2xl border border-red-200 dark:border-red-800">
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mb-4">
                Fix common issues and avoid mistakes that trip up Markdown
                users.
              </p>
              <ul className="space-y-2 text-sm">
                <li>
        ...
        <section className="bg-slate-900 dark:bg-slate-800 text-white rounded-3xl p-8 md:p-12 text-center space-y-6">
          ...
          <p className="text-lg text-slate-300 max-w-xl mx-auto">
            Put your knowledge to the test. Our live editor lets you practice
            everything you've learned with instant preview.
          </p>
          <Link
            href="/"
