...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Avoid frustrating formatting issues with this guide to the most common Markdown mistakes.",
...
export default function CommonMarkdownMistakesGuide() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        headline: "Common Markdown Mistakes and How to Avoid Them",
        description:
          "Avoid frustrating formatting issues with this guide to the most common Markdown mistakes developers make. Learn proper syntax, spacing, and escape techniques.",
        author: {
          "@type": "Person",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: "https://mdviewer.in/guides/common-markdown-mistakes",
          },
        ],
      },
    ],
      ...
      <article className="max-w-4xl mx-auto py-12 px-4 space-y-12 w-full min-w-0 break-words">
        ...
        <header className="space-y-6 border-b pb-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Markdown is simple, but there are subtle gotchas that trip up
            beginners and experienced users alike. Learn to recognize and fix
        ...
        <section className="space-y-10">
          ...
          <div className="space-y-4 pb-8 border-b">
            <div className="flex gap-4 items-start">
              <div className="h-10 w-10 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center shrink-0 font-bold text-red-600 dark:text-red-400">
                1
              </div>
              <div className="space-y-3 flex-1">
                <h2 className="text-2xl font-bold">Forgetting Blank Lines</h2>
                <p className="text-muted-foreground">
                  Markdown often requires blank lines between different
                  elements. Without them, content can render incorrectly or
                  merge together unexpectedly.
                </p>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm">
                  ...
                  <span className="text-blue-700 dark:text-blue-300">
                    Add a blank line before and after headings, lists, code
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h2 className="text-2xl font-bold">
                  Missing Space After Hash for Headings
                </h2>
                <p className="text-muted-foreground">
                  Headings require a space between the hash symbol(s) and the
                  text. Without it, many parsers won't recognize it as a
                  heading.
                </p>
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-950/30 rounded-xl p-4 border border-red-200 dark:border-red-800">
          ...
          <div className="space-y-4 pb-8 border-b">
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-muted-foreground">
                  Nested lists require consistent indentation (usually 2 or 4
                  spaces). Mixing tabs and spaces or using inconsistent
                  indentation breaks the hierarchy.
                </p>
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-950/30 rounded-xl p-4 border border-red-200 dark:border-red-800">
                    <div className="text-xs font-medium text-red-800 dark:text-red-200 mb-2">
          ...
          <div className="space-y-4 pb-8 border-b">
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-muted-foreground">
                  Link syntax is [text](url), with square brackets first. Many
                  beginners swap the order or forget which type of bracket to
                  use.
                </p>
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-950/30 rounded-xl p-4 border border-red-200 dark:border-red-800">
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm">
                  ...
                  <span className="text-blue-700 dark:text-blue-300">
                    "Text comes first, then the parenthetical URL" — or think of
                    it as [label](destination).
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-muted-foreground">
                  ...
                  Markdown. To display them literally, you need to escape them
                  with a backslash.
                </p>
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-950/30 rounded-xl p-4 border border-red-200 dark:border-red-800">
                    ...
                    <div className="mt-2 text-sm text-muted-foreground">
                      Renders as: Use <em>asterisks</em> for emphasis
                    </div>
                  </div>
                  <div className="bg-green-50 dark:bg-green-950/30 rounded-xl p-4 border border-green-200 dark:border-green-800">
                    <div className="text-xs font-medium text-green-800 dark:text-green-200 mb-2">
                    ...
                    <div className="mt-2 text-sm text-muted-foreground">
                      Renders as: Use *asterisks* for emphasis
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4 pb-8 border-b">
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-muted-foreground">
                  While code blocks work without a language, adding the language
                  enables syntax highlighting and makes code much more readable.
                </p>
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-950/30 rounded-xl p-4 border border-red-200 dark:border-red-800">
                    <div className="text-xs font-medium text-red-800 dark:text-red-200 mb-2">
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-3 flex-1">
                <h2 className="text-2xl font-bold">
                  Trailing Spaces vs. Line Breaks
                </h2>
                <p className="text-muted-foreground">
                  In standard Markdown, a single newline doesn't create a new
                  line in the output. You need two spaces at the end of a line,
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
                  <div className="font-semibold text-amber-800 dark:text-amber-200 mb-2">
                    Different Markdown flavors handle this differently:
                  </div>
                  <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                    <li>
                      • <strong>GitHub Flavored Markdown:</strong> Newlines
                      create line breaks
                    </li>
                    <li>
                      • <strong>Standard Markdown:</strong> Need two trailing
                      spaces or blank line
                    </li>
                    <li>
                      • <strong>CommonMark:</strong> Need backslash or two
                      spaces for hard break
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr className="border-b">
                  <td className="p-4">Heading not rendering</td>
                  <td className="p-4">
                    Add space after # and blank line before/after
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-4">List items merging</td>
                  <td className="p-4">
                    Add blank line before list, use consistent spacing
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-4">Link not clickable</td>
                  <td className="p-4">
                    Check [text](url) order, include https://
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-4">Code block not formatted</td>
                  <td className="p-4">
                    Use three backticks, add language specifier
                  </td>
                </tr>
                <tr className="border-b">
                  <td className="p-4">Special character appearing</td>
                  <td className="p-4">Escape with backslash: \* \_ \#</td>
                </tr>
                <tr>
                  <td className="p-4">Text running together</td>
                  <td className="p-4">Add blank lines between sections</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/30 rounded-3xl p-8 md:p-12 border border-red-200 dark:border-red-800 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Use MDViewer to experiment with Markdown syntax and see instant
            previews. It's the fastest way to learn correct formatting.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <h3 className="font-bold group-hover:text-primary transition-colors">
                Complete Markdown Tutorial &rarr;
              </h3>
              <p className="text-sm text-muted-foreground mt-2">
                Learn the fundamentals of Markdown from scratch with our
            ...
            >
              <h3 className="font-bold group-hover:text-primary transition-colors">
                GitHub Flavored Markdown Guide &rarr;
              </h3>
              <p className="text-sm text-muted-foreground mt-2">
                Master GFM features like tables, task lists, and syntax
                highlighting.
              </p>
            </Link>
          </div>
