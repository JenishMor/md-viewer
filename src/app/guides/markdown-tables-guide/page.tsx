...
export const metadata: Metadata = {
  ...
  description:
    "Master table creation in Markdown. Learn alignment, formatting within cells, and workarounds for complex table layouts. Complete guide with examples.",
  keywords: [
    "markdown tables",
  ...
  openGraph: {
    ...
    description:
      "Master table creation in Markdown with alignment, cell formatting, and advanced techniques.",
...
export default function MarkdownTablesGuide() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        headline: "Markdown Tables: From Basic to Advanced Styling",
        description:
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: "https://mdviewer.in/guides/markdown-tables-guide",
          },
        ],
      },
    ],
      ...
      <article className="max-w-4xl mx-auto py-12 px-4 space-y-12">
        ...
        <header className="space-y-6 border-b pb-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Tables in Markdown are a GitHub Flavored Markdown extension that
            lets you organize data in rows and columns. This guide covers
            everything from basic syntax to advanced techniques for complex
            table layouts.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              ...
              delimiter row (which separates header from body), and the body
              rows. Use pipes (<code>|</code>) to separate columns and hyphens (
              <code>-</code>) in the delimiter row.
            </p>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              Control text alignment using colons in the delimiter row. This is
              especially useful for numeric data (right-align) or centered
              headers.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            <div className="bg-card rounded-xl p-6 border">
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b">
                    <td className="p-2 text-left">Apple</td>
                    <td className="p-2 text-center">10</td>
                    <td className="p-2 text-right">$1.50</td>
                  </tr>
                  <tr className="border-b">
                    <td className="p-2 text-left">Banana</td>
                    <td className="p-2 text-center">25</td>
                    <td className="p-2 text-right">$0.75</td>
                  </tr>
                  <tr>
                    <td className="p-2 text-left">Orange</td>
                    <td className="p-2 text-center">15</td>
                    <td className="p-2 text-right">$2.00</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              You can use inline Markdown formatting inside table cells: bold,
              italic, code, and links all work.
            </p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border font-mono text-sm">
            <div className="text-xs text-muted-foreground mb-3 font-sans font-medium">
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              If you need to include a literal pipe character (<code>|</code>)
              in a cell, escape it with a backslash: <code>\|</code>
            </p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border font-mono text-sm">
        ...
        <section className="space-y-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-4">
            <p>
              ...
              Understanding these helps you know when to use alternatives.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-green-50 dark:bg-green-950/30 rounded-2xl border border-green-200 dark:border-green-800">
              ...
              <ul className="space-y-2 text-sm text-green-700 dark:text-green-300">
                ...
                <li>
                  • Use{" "}
                  <code className="bg-muted px-1 rounded">&lt;br&gt;</code> for
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-start p-5 bg-card rounded-xl border">
              ...
              <div>
                <h4 className="font-semibold">
                  Align your pipes for readability
                </h4>
                <p className="text-sm text-muted-foreground mt-1">
                  While not required, aligned pipes make raw Markdown much
            ...
            <div className="flex gap-4 items-start p-5 bg-card rounded-xl border">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Wide tables are hard to read on mobile. Consider breaking data
            ...
            <div className="flex gap-4 items-start p-5 bg-card rounded-xl border">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Headers should clearly describe what each column contains.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-cyan-50 to-teal-50 dark:from-cyan-950/30 dark:to-teal-950/30 rounded-3xl p-8 md:p-12 border border-cyan-200 dark:border-cyan-800 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Use MDViewer to experiment with table syntax and see instant
            previews of your tables.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Tables are a GFM feature. Master all the other extensions too.
              </p>
            </Link>
            <Link
            ...
            >
              <h3 className="font-bold group-hover:text-primary transition-colors">
                Technical Documentation Guide &rarr;
              </h3>
              <p className="text-sm text-muted-foreground mt-2">
                Learn to use tables effectively in professional documentation.
              </p>
            </Link>
          </div>
        </section>
