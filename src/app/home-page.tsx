          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6 p-8 bg-muted/30 rounded-3xl border">
              <h3 className="text-2xl font-bold flex items-center gap-3">
                <span className="text-blue-700 dark:text-blue-400 underline decoration-blue-500/30 underline-offset-8">Developers & Engineers</span>
              </h3>
            ...
            <div className="space-y-6 p-8 bg-muted/30 rounded-3xl border">
              <h3 className="text-2xl font-bold flex items-center gap-3">
                <span className="text-purple-700 dark:text-purple-400 underline decoration-purple-500/30 underline-offset-8">Content Creators & Bloggers</span>
              </h3>
              <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-slate-100 dark:bg-slate-900/50 rounded-xl space-y-2">
                    <div className="font-bold flex justify-between items-center text-slate-900 dark:text-slate-100">
                      ...
                      <span className="text-xs text-slate-700 dark:text-slate-300 font-medium">Advanced</span>
                    </div>
                    <p className="text-sm text-slate-700 dark:text-slate-300">Use pipes (|) to separate columns and hyphens (-) to create the header row. Alignment can be controlled with colons (:).</p>
                  </div>
                  <div className="p-4 bg-slate-100 dark:bg-slate-900/50 rounded-xl space-y-2">
                    <div className="font-bold flex justify-between items-center text-slate-900 dark:text-slate-100">
                        <span>How to add images?</span>
                        <span className="text-xs text-slate-700 dark:text-slate-300 font-medium">Essential</span>
                    </div>
                    <p className="text-sm text-slate-700 dark:text-slate-300">Use the syntax <code>![Alt Text](Image Link)</code>. In MDViewer, images will render instantly in the preview panel.</p>
                  </div>
                  <div className="p-4 bg-slate-100 dark:bg-slate-900/50 rounded-xl space-y-2">
                    <div className="font-bold flex justify-between items-center text-slate-900 dark:text-slate-100">
                        <span>Can I use HTML tags?</span>
                        <span className="text-xs text-slate-700 dark:text-slate-300 font-medium">Pro</span>
                    </div>
                    <p className="text-sm text-slate-700 dark:text-slate-300">Yes! Markdown allows you to drop into raw HTML for unsupported styles like <code>&lt;kbd&gt;</code> or <code>&lt;details&gt;</code>.</p>
                  </div>
                </div>
              </div>
            </div>
